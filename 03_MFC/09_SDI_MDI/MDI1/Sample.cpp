...
{
	AfxEnableControlContainer();// Active X지원(COM)
...
//		return FALSE;
	...
	// DocTemplate에게 ChildFrame과 Doc를 만들게 한다.
	CDocument* pDoc = pDocTemplate->CreateNewDocument();

	CMDIChildWnd* p = 
		(CMDIChildWnd*)pDocTemplate->CreateNewFrame(pDoc, 0);
	
	p->InitialUpdateFrame( pDoc, TRUE);
	////////////////////////////////////////////////////////
