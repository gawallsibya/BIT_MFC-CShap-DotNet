// Sample3.cpp : Defines the class behaviors for the application.
//
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CSample3App object
...
BOOL CSample3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSample3Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CSample3View));
