...
void CMainFrame::OnReleasedcaptureSlider1(NMHDR *pNMHDR, LRESULT *pResult)
{
	CSliderCtrl	*ctrlTEST = (CSliderCtrl*)m_wndMyDialogBar.GetDlgItem(IDC_SLIDER1);

	

	int n = ctrlTEST->GetPos();
